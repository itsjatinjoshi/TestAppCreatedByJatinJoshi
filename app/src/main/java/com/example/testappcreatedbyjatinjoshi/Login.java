    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if(etMail.getText().toString().isEmpty() || etPassword.getText().toString().isEmpty()){
                    ...
                    Backendless.UserService.login(email, password, new AsyncCallback<BackendlessUser>() {
                        ...
                        public void handleFault(BackendlessFault fault) {
                            ...
                            Toast.makeText(Login.this, "Error : " +fault, Toast.LENGTH_LONG).show();
                            showProgress(true);
                        }
                    }, true);
                }
        ...
        tvReset.setOnClickListener(new View.OnClickListener() {
            ...
            if(etMail.getText().toString().isEmpty()){
                Toast.makeText(Login.this, "Please enter your email please", Toast.LENGTH_SHORT).show();
                showProgress(false);
            }
            else{
                String email= etMail.getText().toString().trim();
                Backendless.UserService.restorePassword(email, new AsyncCallback<Void>() {
                    ...
                    public void handleResponse(Void response) {
                        Toast.makeText(Login.this, "Reset Password instruction has sent to your email" , Toast.LENGTH_LONG).show();
                        showProgress(false);
