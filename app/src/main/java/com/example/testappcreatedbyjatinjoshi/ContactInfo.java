                        ...
                        Backendless.Persistence.of(Contact.class).remove(ApplicationClass.contacts.get(index),
                                new AsyncCallback<Long>() {
                                    ...
                                    public void handleResponse(Long response) {
                                        ...
                                        Toast.makeText(ContactInfo.this, "Contact Deleted Successfully",
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                || etMail.getText().toString().isEmpty()){
                    Toast.makeText(ContactInfo.this, "Please fill all the fields",
                            Toast.LENGTH_LONG).show();
                }
                else{
                    ...
                    showProgress(true);
                    tvLoad.setText("Updating Contact List...Please wait...");
                    ...
                    Backendless.Persistence.save(ApplicationClass.contacts.get(index), new AsyncCallback<Contact>() {
                        ...
                        public void handleResponse(Contact response) {
                            ...
                            Toast.makeText(ContactInfo.this, "Contact has been updated", Toast.LENGTH_LONG).show();
                            showProgress(false);
                        }
